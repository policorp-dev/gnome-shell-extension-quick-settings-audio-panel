% gnome-shell-extension-quick-settings-audio-panel(SECTION) | User Commands
%
% "January 24 2025"
...
gnome-shell-extension-quick-settings-audio-panel - program to do something

# SYNOPSIS

**gnome-shell-extension-quick-settings-audio-panel** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gnome-shell-extension-quick-settings-audio-panel** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gnome-shell-extension-quick-settings-audio-panel** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gnome-shell-extension-quick-settings-audio-panel** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gnome-shell-extension-quick-settings-audio-panel. See **foo.conf**(5) for further details.
...
**gnome-shell-extension-quick-settings-audio-panel** provides some return codes, that can be used in scripts:
